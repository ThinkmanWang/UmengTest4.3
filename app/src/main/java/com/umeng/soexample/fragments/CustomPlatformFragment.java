...
public class CustomPlatformFragment extends Fragment implements OnClickListener {
    ...
    private void login(final SHARE_MEDIA platform) {
        mController.doOauthVerify((Context)getActivity(), platform, new UMAuthListener() {
    ...
    private OnSensorListener mSensorListener = new OnSensorListener() {
         ...
         * 分享完成后回调 (non-Javadoc)
         * 
         * @see com.umeng.socialize.controller.listener.SocializeListeners.DirectShareListener#onOauthComplete(String,
